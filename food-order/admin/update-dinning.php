    ...
    <div class="wrapper">
        ...
        <?php 
            ...
            if(isset($_GET['id']))
            {
                ...
                $sql = "SELECT * FROM tbl_dinning WHERE id=$id";
                ...
                else
                {
                    ...
                    $_SESSION['no-category-found'] = "<div class='error'>Restaurant not Found.</div>";
                    ...
                    <td>
                        <?php 
                            if($current_image != "")
                            {
                                //Display the Image
                                ?>
                                <img src="<?php echo SITEURL; ?>images/dinning/<?php echo $current_image; ?>" width="150px">
                                <?php
                            }
                            else
                            {
            ...
            if(isset($_POST['submit']))
            {
                ...
                if(isset($_FILES['image']['name']))
                {
                    ...
                    if($image_name != "")
                    {
                        ...
                        //Rename the Image
                        $image_name = "Food_Dinning_".rand(000, 999).'.'.$ext; // e.g. Food_Category_834.jpg
                        ...
                        if($current_image!="")
                        {
                            $remove_path = "../images/dinning/".$current_image;
